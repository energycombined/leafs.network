<%@ Page Title="Experiment view" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="View.aspx.cs" Inherits="Batteries.Experiments.View" %>
            ...
            <div class="col-md-10 col-lg-8 col-lg-offset-2">
                <div id="Anode" class="box box-warning collapsed-box batteryComponent">
                    <div class="box-header with-border">
                        ...
                        <div class="boxButtons pull-right">
                            <div onclick="ShowFileAttachmentsExperiment('Component', <%=experimentId %>, 1, 0)" class="btn btn-xs btn-default documentsButton">Documents</div>
                        </div>
                    </div>
                    <!-- /.box-header -->
                ...
                <div id="Cathode" class="box box-warning collapsed-box batteryComponent">
                    <div class="box-header with-border">
                        ...
                        <div class="boxButtons pull-right">
                            <div onclick="ShowFileAttachmentsExperiment('Component', <%=experimentId %>, 2, 0)" class="btn btn-xs btn-default documentsButton">Documents</div>
                        </div>
                    </div>
                    <!-- /.box-header -->
                ...
                <div id="Separator" class="box box-warning collapsed-box batteryComponent">
                    <div class="box-header with-border">
                        ...
                        <div class="boxButtons pull-right">
                            <div onclick="ShowFileAttachmentsExperiment('Component', <%=experimentId %>, 3, 0)" class="btn btn-xs btn-default documentsButton">Documents</div>
                        </div>
                    </div>
                    <!-- /.box-header -->
                ...
                <div id="Electrolyte" class="box box-warning collapsed-box batteryComponent">
                    <div class="box-header with-border">
                        ...
                        <div class="boxButtons pull-right">
                            <div onclick="ShowFileAttachmentsExperiment('Component', <%=experimentId %>, 4, 0)" class="btn btn-xs btn-default documentsButton">Documents</div>
                        </div>
                    </div>
                    <!-- /.box-header -->
                ...
                <div id="ReferenceElectrode" class="box box-warning collapsed-box batteryComponent">
                    <div class="box-header with-border">
                        ...
                        <div class="boxButtons pull-right">
                            <div onclick="ShowFileAttachmentsExperiment('Component', <%=experimentId %>, 5, 0)" class="btn btn-xs btn-default documentsButton">Documents</div>
                        </div>
                    </div>
                    <!-- /.box-header -->
                ...
                <div id="Casing" class="box box-warning collapsed-box batteryComponent">
                    <div class="box-header with-border">
                        ...
                        <div class="boxButtons pull-right">
                            <div onclick="ShowFileAttachmentsExperiment('Component', <%=experimentId %>, 6, 0)" class="btn btn-xs btn-default documentsButton">Documents</div>
                        </div>
                    </div>
                    <!-- /.box-header -->
