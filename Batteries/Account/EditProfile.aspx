<%@ Page Title="Edit Profile" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditProfile.aspx.cs" Inherits="Batteries.Account.EditProfile" %>
                ...
                <div class="box">
                    ...
                    <fieldset class="form-horizontal">
                        ...
                        <div class="box-footer">
                            <div class="pull-left">
                                <a href="<%=ResolveUrl("~/Account/Manage")%>" class="btn btn-default">Change password</a>
                            </div>
