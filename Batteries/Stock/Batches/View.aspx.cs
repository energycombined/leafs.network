...
namespace Batteries.Stock.Batches
{
    public partial class View : System.Web.UI.Page
    {
        ...
        {
            var currentUser = UserHelper.GetCurrentUser();
            var stockTransaction = StockTransactionDa.GetAllBatchStockTransactions(stockTransactionId);
        ...
        private void Fill(StockTransactionExt stockTransaction)
        {
            ...
            LblTransactionType.Text = stockTransaction.amount.ToString();
            LblSystemLabel.Text = stockTransaction.batchSystemLabel;
            LblPersonalLabel.Text = stockTransaction.batchPersonalLabel;
            ...
            LblChemicalFormula.Text = stockTransaction.batchChemicalFormula;
